...
class SemanticSegmentator:
    def __init__(self, image, model_path, output_class_file) -> None:
        ...
        # generate colors
        np.random.seed(42)
        self.colors = np.random.randint(0, 255, size=(len(self.output_classes - 1)), dtype=np.uint8)
    ...
    def Segment(self):
        ...
        output = cv2.addWeighted(output, 0.3, mask, 0.7, 0)
